...
1. **Download** the latest `Typesense-Desktop_1.1.0.dmg` from [Releases](https://github.com/jasonstrs/typesense-desktop/releases)
...
1. **Download** the latest `Typesense-Desktop_1.1.0.msi` from [Releases](https://github.com/jasonstrs/typesense-desktop/releases)
...
1. **Download** the latest `typesense-desktop_1.1.0_amd64.deb` from [Releases](https://github.com/jasonstrs/typesense-desktop/releases)

2. **Install** the package:

   ```bash
   sudo dpkg -i typesense-desktop_1.1.0_amd64.deb
   ```
